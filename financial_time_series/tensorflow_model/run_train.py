...
def run_training(argv=None):
  ...
  storage_helper.download_blob(args.bucket, args.store_path, file_path, args.endpoint_url, args.access_key, args.secret_key)
  ...
  storage_helper.upload_to_storage(args.bucket, export_path, args.endpoint_url, args.access_key, args.secret_key)
